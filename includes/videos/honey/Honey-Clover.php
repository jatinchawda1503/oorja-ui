            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/honey-Clover.php">Honey-Clover</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="single-product-img">
                    <div class="pro-slide js-product-slider">
                        <div class="item">
                        <img src="<?php echo $base?>/includes/images/product/chs 1.jpeg" class="img-responsive" alt="Product" title="images products">
                        </div>
                        <div class="item">
            ...
            <div class="col-md-6">
                <div class="single-product-infor">
                    ...
                    <div class="pro-desc">
                        ...
                        <p>Our organic clover honey comes from the nectar of carefully curated clover plants. Clover honey is widely popular. Its sweet and mildly floral taste makes it the preferred choice for honey enthusiasts. It is the ideal replacement for sugar.
</p>
                        
                        <p>Benefits of our premium clover honey include: </p>
