            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/Honey-Ginger.php">Honey-Ginger</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="single-product-img">
                    <div class="pro-slide js-product-slider">
                        <div class="item">
                        <img src="<?php echo $base?>/includes/images/product/ghs.jpeg" class="img-responsive" alt="Product" title="images products">
                        </div>
                        <div class="item">
            ...
            <div class="col-md-6">
                <div class="single-product-infor">
                    ...
                    <div class="pro-desc">
                        ...
                        <p>Our Ginger Honey comes predominantly from apiaries on ginger plantations. This product is made of honey derived from the wildflowers of India. The wildflowers from which the honey is made can be experienced in every bit of this exotic honey. The complement of ginger doesn’t only provide a delicious contrast of flavor, but also increases the nutritious benefits of this product. Our organic honey flavored with ginger has a unique, delectable flavor.</p>
                        
                        <p>The benefits of this combination are present in the Ayurveda as well. This medically renowned honey has the following health benefits: </p>

                        <ul class="sub-details">
                           <li> Natural Home Remedy for cough and cold Natural Pain Killer.i> 
                           <li> Beneficial for heart health </li> 
                           <li> It helps promote a healthy immune system </li>
                           <li> It helps reduce indigestion. </li> 
                           <li> Helps Prevents Nausea & Morning Sickness.  </li> 
                        </ul>
