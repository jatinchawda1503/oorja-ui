            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/Honey-Coffee.php">Honey-Coffee</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="single-product-img">
                    <div class="pro-slide js-product-slider">
                        <div class="item">
                        <img src="<?php echo $base?>/includes/images/product/chs.jpeg" class="img-responsive" alt="Product" title="images products">
                        </div>
                        <div class="item">
            ...
            <div class="col-md-6">
                <div class="single-product-infor">
                    ...
                    <div class="pro-desc">
                        ...
                        <p>A comforting, earthy coffee-flavored honey that helps us ease into the day.
This blend of coffee-infused honey is unique and exciting. It has a dark amber color and a distinctive taste with a tinge of the coffee flavor. Our process of infusion is completely organic and does not include any preservatives or chemicals added to the product. This helps us serve you the freshest honey. This delectable blend can be added to cold coffee, coffee cakes, coffee ice cream and so much more!
</p>
                        
                        <p>Humanity runs on coffee, it and has amazing health benefits too! Some of them include: </p>
