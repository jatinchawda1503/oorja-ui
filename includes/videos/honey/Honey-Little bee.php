            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/Honey-Little bee.php">Honey-Little bee</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="single-product-img">
                    <div class="pro-slide js-product-slider">
                        <div class="item">
                        <img src="<?php echo $base?>/includes/images/product/nbhs.jpeg" class="img-responsive" alt="Product" title="images products">
                        </div>
                        <div class="item">
            ...
            <div class="col-md-6">
                <div class="single-product-infor">
                    ...
                    <div class="pro-desc">
                        ...
                        <p>Natural Honey is collected naturally from the hilly areas of Kashmir. It is completely pure and raw.</p>
                        
                        <p> Our pure Acacia honey has been health benefits </p>

                        <ul class="sub-details">
                           <li> It helps in treating respiratory infections..</li> 
                           <li> It helps alleviate insomnia and promotes sound sleep </li> 
                           <li> It helps reduce obesity. </li> 
                           <li> It treats infections and heals wounds</li> 
                        </ul>
