            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/Himachal multi-floral honey.php">Himachal multi-floral honey</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
        ...
        <div class="single-product-detail row">
            ...
            <div class="col-md-6">
                <div class="single-product-infor">
                    <div class="pro-title">
                        <h1>Himachal multi-floral honey</h1>
                    </div>
                    <div class="pro-star">
                    ...
                    <div class="pro-desc">
                        ...
                        <p>Our line of Himachal honey comes from the agricultural regions of Himachal Pradesh. Multi-floral honey is a rare find. The color is light and mild, and the taste is deliciously fruity and rich</p>
                        
                        <p>Benefits of multi-floral honey include: </p>

                        <ul class="sub-details">
                           <li> Helps lower risk of heart disease. </li> 
                           <li> Enhances your immune system. </li> 
                           <li> Helps treat respiratory diseases. </li> 
                           <li> Helps in preventing acid reflux. </li>
                           <li> Helps counter aging. </li> 
                        </ul>
