            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/Honey Rose.php">Honey Rose</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="single-product-infor">
                    ...
                    <div class="pro-desc">
                        ...
                        <p>The perfect concoction of rose flowers and honey!
This combination is completely organic, it contains fresh pink roses from the hills. It does not contain any extracts and is made from a mixture of fresh roses to maximize nutritional benefits.
It has an enticing sweet taste and can be used to make a rose milkshake, rose petal ice-cream, desserts, and even as an aesthetic filing for cookies!
</p>
                        
                        <p> The health benefits of this flower-infused honey are aplenty. Some of these include: </p>
