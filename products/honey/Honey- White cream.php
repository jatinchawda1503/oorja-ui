            ...
            <div class="inner">
                <div class="breadcrumb-content">
                    <ul>
                        <li>Shop</li>
                        <li>Honey</li>
                        <li><a href="/products/honey/Honey- White cream.php">Honey- White cream</a></li>                    
                    </ul>                 
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="single-product-img">
                    <div class="pro-slide js-product-slider">
                        <div class="item">
                        <img src="<?php echo $base?>/includes/images/product/wchs.jpeg" class="img-responsive" alt="Product" title="images products">
                        </div>
                        <div class="item">
...
<li class="nav-item">
    <a class="nav-link" data-toggle="tab" href="#360" role="tab" aria-expanded="false">500gm</a>
                    ...
                    <div class="pro-desc">
                        ...
                        <p>White cream honey is produced from the nectar of the Sage flower. The honey is collected as a liquid and naturally crystallizes to a smooth, creamy-white with a texture that is easy to spread like butter. It is lighter in color than traditional honey, as its name suggests.</p>
                        
                        <p>The health benefits of this deliciously creamy honey include:</p>
